...
CROSS JOIN 
	...
	---3)Using Products, Suppliers table List only the combinations
...
INNER JOIN 
	...
	students
	inner join
	enrollments on students.StudentID = Enrollments.EnrollmentID
...
INNER JOIN 
	...
	11)---Using Employees, Departments table List employee names 
	--and department names where department IDs are not equal. 
...
orders
inner join
payments on payments.amount < orders.totalamount
