...
select 
Products.ProductName,
sum(Sales.SaleAmount) as totalAmount
from 
Products
join
Sales on Products.ProductID=Sales.ProductID
...
and Products.StockQuantity > 100
...
join
Departments on Employees.DepartmentID=Departments.DepartmentID
where Departments.DepartmentName like 'sales'
...
Orders on Customers.CustomerID=Orders.CustomerID
where Customers.Country like 'usa'
and Customers.Address like '[1-9],[1-9],[1-9],[1-9]'
...
sum(products.ProductID) as productCount
from
Categories
join
Products on Products.Category=Categories.CategoryID
...
join
orders on Customers.CustomerID=Orders.CustomerID
where Customers.City like 'los angeles'
