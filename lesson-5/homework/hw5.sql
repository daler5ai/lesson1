...
select ProductName as name from mahsulot 
...
INSERT INTO mijoz (CustomerID, FirstName, LastName, Email, Phone, Address, City, State, PostalCode, Country) VALUES
...
select * from mijoz
select * from mijoz as client

CREATE TABLE mahsulot_Discounted (
    ProductID INT PRIMARY KEY,
    ProductName VARCHAR(100),
    Price DECIMAL(10, 2),
    Category VARCHAR(50),
...
INSERT INTO mahsulot_Discounted VALUES
...
INSERT INTO sotuv (SaleID, ProductID, CustomerID, SaleDate, SaleAmount) VALUES
...
INSERT INTO Invoys (InvoiceID, CustomerID, InvoiceDate, TotalAmount) VALUES
...
INSERT INTO OutOfStock1 VALUES
...
INSERT INTO ishchi (EmployeeID, FirstName, LastName, DepartmentName, Salary, HireDate, Age, Email, Country) VALUES
...
select productname from mahsulot
union
select productname from mahsulot_discounted
...
SELECT 
    ProductName,
    StockQuantity,
    IIF(StockQuantity > 100, 'Yes', 'No') AS AdequateStock
FROM mahsulot_Discounted;
