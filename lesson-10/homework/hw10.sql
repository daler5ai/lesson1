...
1)--Using the Employees and Departments tables,write a query to return the names 
--and salaries of employees whose salary is greater than 50000, along with their department names.
...
2)--Using the Customers and Orders tables, write a query to display customer names 
--and order dates for orders placed in the year 2023.
...
select
Employees.name as empID,
Employees.ManagerID as mID
from
Employees
left join
Employees on Employees.ManagerID=Employees.EmployeeID
...
Enrollments
join
students on Students.StudentID=Enrollments.StudentID
join
...
10)--Using the Employees and Departments tables, write a query
--to return department names that have more than 5 employees.
...
where Products.StockQuantity is null

12)--Using the Customers and Orders tables, write a query
...
WHERE 
    e1.ManagerID IS NOT NULL;--------chunmadimmmm


	15)--Using the Orders and Customers tables, write a query
...
16)--Using the Employees and Departments tables, write a query to return employees
--from the 'Sales' department whose salary is above 60000.
--🔁 Expected Columns: EmployeeName, Salary, DepartmentName
...
17)--Using the Orders and Payments tables, write a query 
...
19)--Using the Employees table, write a query to find employees
...
24)--Using the Products and Sales tables, write a query to list sales
--where the amount is greater than 500, including product names.
...
27)--Using the Products and Categories tables, write a query 
